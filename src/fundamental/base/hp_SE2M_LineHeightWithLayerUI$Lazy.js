...
HuskyCore.mixin(SE2M_LineHeightWithLayerUI, {
  ...
  _assignHTMLObjects: function (elAppContainer) {
    ...
    this.aLIOptions = jindo.$A(jindo.$$('LI', this.oDropdownLayer)).filter(function (v) {
  ...
  $LOCAL_BEFORE_FIRST: function () {
    ...
    for (var i = 0; i < this.aLIOptions.length; i++) {
      this.oApp.registerBrowserEvent(this.aLIOptions[i], 'click', 'SET_LINEHEIGHT_FROM_LAYER_UI', [
