 ...
 */
export const SE2M_Accessibility = jindo.$Class({
  ...
  $ON_MSG_APP_READY: function () {
    this.htAccessOption = SE2M_Configuration.SE2M_Accessibility || {};
  ...
  $LOCAL_BEFORE_FIRST: function (/*sMsg*/) {
    jindo
      .$Fn(jindo.$Fn(this.oApp.exec, this.oApp).bind('CLOSE_HELP_POPUP', [this.oCloseButton]), this)
      .attach(this.oCloseButton, 'click');
    jindo
      .$Fn(jindo.$Fn(this.oApp.exec, this.oApp).bind('CLOSE_HELP_POPUP', [this.oCloseButton2]), this)
