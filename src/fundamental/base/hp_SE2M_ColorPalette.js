...
export const SE2M_ColorPalette = jindo
  .$Class({
    ...
    _assignHTMLElements: function (oAppContainer) {
      var htConfiguration = SE2M_Configuration.SE2M_ColorPalette;
      if (htConfiguration) {
        var LinkageDomain = SE2M_Configuration.LinkageDomain || {};
    ...
    $ON_APPLY_COLOR: function (elButton) {
      ...
      if (welColorParent.hasClass('husky_se2m_color_palette')) {
         ...
         * 설정값 제거(r12236) 전에도
         * 모든 타입에서
         * SE2M_Configuration.SE2M_ColorPalette.bAddRecentColorFromDefault 값이
