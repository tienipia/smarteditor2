...
export const SE_EditingArea_WYSIWYG = jindo.$Class({
  ...
  $init: function (iframe) {
    ...
    this.htOptions = SE2M_Configuration.SE_EditingAreaManager;
    if (this.htOptions) {
  ...
  _setAutoResize: function () {
    ...
    this.nTopBottomMargin =
      this.nTopBottomMargin || parseInt(welBody.css('marginTop'), 10) + parseInt(welBody.css('marginBottom'), 10);
  ...
  _clearCursorHolderValue: function (oNode) {
    if (oNode && oNode.nodeType === 3 && (oNode.nodeValue === '\u200B' || oNode.nodeValue === '\uFEFF')) {
      oNode.nodeValue = '';
    }
  },
      ...
      if (oStartContainer.nodeType === 1 && oStartContainer.tagName === 'P') {
        ...
        if (aImgChild.length > 0) {
          ...
          while (elChild) {
            ...
            if (
              elChild.nodeType === 3 &&
              (elChild.nodeValue === '&nbsp;' || elChild.nodeValue === unescape('%u00A0'))
            ) {
  ...
  initIframe: function () {
    try {
      ...
      var sCSSBaseURI =
        !!SE2M_Configuration.SE2M_CSSLoader && SE2M_Configuration.SE2M_CSSLoader.sCSSBaseURI
          ? SE2M_Configuration.SE2M_CSSLoader.sCSSBaseURI
          : '';

      if (SE2M_Configuration.SE_EditingAreaManager.sCSSBaseURI) {
        sCSSBaseURI = SE2M_Configuration.SE_EditingAreaManager.sCSSBaseURI;
      }
