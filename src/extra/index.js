...
window.oMessageMap_ja_JP = {
  ...
  'SE2M_EditingModeChanger.confirmTextMode':
    'テキストモードに切り換えると、作成された内容は維持されますが、\n\nフォント等の編集効果と画像等の添付内容が消えることになります。\n\n切り換えますか？',
...
window.oMessageMap_en_US = {
  ...
  'SE_FindReplace.notSupportedBrowser':
    'Function cannot be used in the browser you are currently using. \n\nSorry for the inconvenience.',
  ...
  'SE2M_EditingModeChanger.confirmTextMode':
    'The contents remain, but editing effects, including fonts, and attachments, \n\nsuch as images, will disappear when changed to text mode. \n\n Make changes?',
